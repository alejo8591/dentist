 ...
 * @property TblBackground[] $tblBackgrounds
 */
class TblPersonalHistory extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'tblBackgrounds' => array(self::HAS_MANY, 'TblBackground', 'id_tbl_personal_history'),
		);
	}
	 ...
	 * @return TblPersonalHistory the static model class
	 */
