...
class OptionsLymphadenopathy extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tbl_anamnesis, id_tbl_physical_examination, flag_option_lymphadenopathy', 'numerical', 'integerOnly'=>true),
			...
			array('id_tbl_option_lymphadenopathy, username, id_tbl_anamnesis, id_tbl_physical_examination, name_option_lymphadenopathy, flag_option_lymphadenopathy, observation_option_lymphadenopathy, create_user_id, create_time, update_user_id, update_time', 'safe', 'on'=>'search'),
		);
	}
