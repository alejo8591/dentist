...
class OptionsObstetricGynecology extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tbl_personal_background, id_tbl_anamnesis, flag_option_option_obstetric_gynecology', 'numerical', 'integerOnly'=>true),
			...
			array('id_tbl_option_obstetric_gynecology, username, id_tbl_personal_background, id_tbl_anamnesis, name_option_obstetric_gynecology, flag_option_option_obstetric_gynecology, observation_option_obstetric_gynecology, create_user_id, create_time, update_user_id, update_time', 'safe', 'on'=>'search'),
		);
	}
