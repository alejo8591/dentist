...
class OptionsAtmMandibularMovements extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tbl_atm, flag_option_atm_mandibular_movements', 'numerical', 'integerOnly'=>true),
			array('name_option_atm_mandibular_movements', 'length', 'max'=>128),
			array('type_option_atm_mandibular_movements, create_user_id, update_user_id', 'length', 'max'=>64),
			array('observation_atm_mandibular_movements, create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_tbl_option_atm_mandibular_movements, id_tbl_atm, name_option_atm_mandibular_movements, type_option_atm_mandibular_movements, flag_option_atm_mandibular_movements, observation_atm_mandibular_movements, create_user_id, create_time, update_user_id, update_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'name_option_atm_mandibular_movements' => 'Nombre del Movimiento Mandibular',
			'type_option_atm_mandibular_movements' => 'Costado del Movimiento Mandibular',
			'flag_option_atm_mandibular_movements' => 'Selección de opción del Movimiento Mandibular',
			'observation_atm_mandibular_movements' => 'Observación del Movimiento Mandibular',
