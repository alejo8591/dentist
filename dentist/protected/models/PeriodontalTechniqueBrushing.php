...
/**
 * This is the model class for table "tbl_periodontal_technique_brushing".
 *
 ...
 * @property string $observations_periodontal_technique_brushing
...
class PeriodontalTechniqueBrushing extends CActiveRecord
{
	...
	{
		return 'tbl_periodontal_technique_brushing';
	}
	...
	public function search()
	{
		...
		$criteria->compare('observations_periodontal_technique_brushing',$this->observations_periodontal_technique_brushing,true);
	 ...
	 * @return PeriodontalTechniqueBrushing the static model class
	 */
