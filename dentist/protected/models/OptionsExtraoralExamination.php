...
class OptionsExtraoralExamination extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tbl_physical_examination, flag_option_extraoral_examination', 'numerical', 'integerOnly'=>true),
			...
			array('id_tbl_option_extraoral_examination, id_tbl_physical_examination, name_option_extraoral_examination, flag_option_extraoral_examination, observation_option_extraoral_examination, create_user_id, create_time, update_user_id, update_time', 'safe', 'on'=>'search'),
		);
	}
