...
/**
 * This is the model class for table "tbl_options_systems".
 *
 ...
 * @property string $type_option_systems
 * @property string $observation_option_systems
...
class OptionsSystems extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'type_option_systems' => 'Type Option Systems',
			'observation_option_systems' => 'Observation Option Systems',
	...
	public function search()
	{
		...
		$criteria->compare('type_option_systems',$this->type_option_systems,true);
		$criteria->compare('observation_option_systems',$this->observation_option_systems,true);
	 ...
	 * @return OptionsSystems the static model class
	 */
