...
/**
 * This is the model class for table "tbl_options_pathological_history".
 *
 ...
 * @property string $observation_option_pathological_history
...
class OptionsPathologicalHistory extends CActiveRecord
{
	...
	{
		return 'tbl_options_pathological_history';
	}
	...
	public function search()
	{
		...
		$criteria->compare('observation_option_pathological_history',$this->observation_option_pathological_history,true);
	 ...
	 * @return OptionsPathologicalHistory the static model class
	 */
