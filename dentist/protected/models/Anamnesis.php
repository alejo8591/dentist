...
class Anamnesis extends DentistActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_tbl_country' => 'Country',
			'id_tbl_city' => 'City',
			'id_tbl_level_schooling' => 'Level Schooling',
			'id_tbl_profession' => 'Profession',
			'occupation' => 'Occupation',
			'contact' => 'Contact',
			'id_tbl_healt_regimen' => 'Healt Regimen',
			'id_tbl_healt_institution' => 'Healt Institution',
			'id_tbl_during_consultation' => 'During Consultation',
