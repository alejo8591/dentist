...
class OptionsAtmIntraoralSoftTissue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tbl_anamnesis, id_tbl_atm, type_option_atm_intraoral_soft_tissue, flag_option_atm_intraoral_soft_tissue', 'numerical', 'integerOnly'=>true),
			...
			array('id_tbl_option_atm_intraoral_soft_tissue, username, id_tbl_anamnesis, id_tbl_atm, name_option_atm_intraoral_soft_tissue, type_option_atm_intraoral_soft_tissue, observation_option_atm_intraoral_soft_tissue, flag_option_atm_intraoral_soft_tissue, create_user_id, create_time, update_user_id, update_time', 'safe', 'on'=>'search'),
		);
	}
