...
class OptionsAtmIntraoralSoftTissue extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'name_option_atm_intraoral_soft_tissue' => 'Nombre del Tipo de Tejido Blando',
			'type_option_atm_intraoral_soft_tissue' => 'Caracteristica del Tipo de Tejido Blando',
			'observation_option_atm_intraoral_soft_tissue' => 'Observaciones de Tipo de Tejido Blando',
			'flag_option_atm_intraoral_soft_tissue' => 'Selección de opción Si/No',
