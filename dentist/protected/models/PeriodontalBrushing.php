...
class PeriodontalBrushing extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tbl_anamnesis, id_tbl_periodontal_examination, type_periodontal_brushing, flag_option_periodontal_brushing', 'numerical', 'integerOnly'=>true),
			...
			array('id_tbl_periodontal_brushing, id_tbl_anamnesis, username, id_tbl_periodontal_examination, name_option_periodontal_brushing, type_periodontal_brushing, flag_option_periodontal_brushing, observations_periodontal_brushing, create_user_id, create_time, update_user_id, update_time', 'safe', 'on'=>'search'),
		);
	}
