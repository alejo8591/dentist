...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'examination-dental-pieces-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'id_tbl_examination_dental_pieces'); ?>
		<?php echo $form->textField($model,'id_tbl_examination_dental_pieces'); ?>
		<?php echo $form->error($model,'id_tbl_examination_dental_pieces'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'name_examination_dental_pieces'); ?>
		<?php echo $form->textField($model,'name_examination_dental_pieces',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'name_examination_dental_pieces'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'type_examination_dental_pieces'); ?>
		<?php echo $form->textField($model,'type_examination_dental_pieces'); ?>
		<?php echo $form->error($model,'type_examination_dental_pieces'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'observation_examination_dental_pieces'); ?>
		<?php echo $form->textArea($model,'observation_examination_dental_pieces',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'observation_examination_dental_pieces'); ?>
	</div>
