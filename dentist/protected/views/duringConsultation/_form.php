...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'name_during_consultation'); ?>
		<?php echo $form->textField($model,'name_during_consultation',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'name_during_consultation'); ?>
	</div>
