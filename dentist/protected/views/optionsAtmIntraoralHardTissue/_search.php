...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_tbl_option_atm_intraoral_hard_tissue'); ?>
		<?php echo $form->textField($model,'id_tbl_option_atm_intraoral_hard_tissue'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'name_option_atm_intraoral_hard_tissue'); ?>
		<?php echo $form->textField($model,'name_option_atm_intraoral_hard_tissue',array('size'=>60,'maxlength'=>128)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'type_option_atm_intraoral_hard_tissue'); ?>
		<?php echo $form->textField($model,'type_option_atm_intraoral_hard_tissue'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'observation_option_hard_intraoral_hard_tissue'); ?>
		<?php echo $form->textArea($model,'observation_option_hard_intraoral_hard_tissue',array('rows'=>6, 'cols'=>50)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'flag_option_atm_intraoral_hard_tissue'); ?>
