...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'options-atm-mandibular-movements-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'type_option_atm_mandibular_movements'); ?>
		<?php echo $form->textField($model,'type_option_atm_mandibular_movements',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'type_option_atm_mandibular_movements'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'flag_option_atm_mandibular_movements'); ?>
		<?php echo $form->textField($model,'flag_option_atm_mandibular_movements'); ?>
		<?php echo $form->error($model,'flag_option_atm_mandibular_movements'); ?>
	</div>
