...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_tbl_option_oral_habits'); ?>
		<?php echo $form->textField($model,'id_tbl_option_oral_habits'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'name_option_oral_habits'); ?>
		<?php echo $form->textField($model,'name_option_oral_habits',array('size'=>60,'maxlength'=>128)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'flag_option_oral_habits'); ?>
		<?php echo $form->textField($model,'flag_option_oral_habits'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'observation_option_oral_habits'); ?>
