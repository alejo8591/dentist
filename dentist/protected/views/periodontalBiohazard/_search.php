...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_tbl_periodontal_biohazard'); ?>
		<?php echo $form->textField($model,'id_tbl_periodontal_biohazard'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'name_periodontal_biohazard'); ?>
		<?php echo $form->textField($model,'name_periodontal_biohazard',array('size'=>60,'maxlength'=>64)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'flag_periodontal_biohazard'); ?>
		<?php echo $form->textField($model,'flag_periodontal_biohazard'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'observation_periodontal_biohazard'); ?>
