...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_tbl_treatment_decision_dental_piece'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'name_treatment_decision_dental_piece'); ?>
		<?php echo $form->textField($model,'name_treatment_decision_dental_piece',array('size'=>60,'maxlength'=>64)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'type_treatment_decision_dental_piece'); ?>
		<?php echo $form->textField($model,'type_treatment_decision_dental_piece'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'observation_treatment_decision_dental_piece'); ?>
