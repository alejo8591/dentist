...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'name_option_intcp'); ?>
		<?php echo $form->textField($model,'name_option_intcp',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'name_option_intcp'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'code_intcp'); ?>
		<?php echo $form->textField($model,'code_intcp',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'code_intcp'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'nt_intcp'); ?>
		<?php echo $form->textField($model,'nt_intcp',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'nt_intcp'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'observation_option_intcp'); ?>
		<?php echo $form->textArea($model,'observation_option_intcp',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'observation_option_intcp'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'flag_option_intcp'); ?>
		<?php echo $form->textField($model,'flag_option_intcp'); ?>
		<?php echo $form->error($model,'flag_option_intcp'); ?>
	</div>
