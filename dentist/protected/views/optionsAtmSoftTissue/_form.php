...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'options-atm-soft-tissue-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'name_option_atm_soft_tissue'); ?>
		<?php echo $form->textField($model,'name_option_atm_soft_tissue',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'name_option_atm_soft_tissue'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'flag_option_atm_soft_tissue'); ?>
		<?php echo $form->textField($model,'flag_option_atm_soft_tissue'); ?>
		<?php echo $form->error($model,'flag_option_atm_soft_tissue'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'observation_atm_soft_tissue'); ?>
		<?php echo $form->textArea($model,'observation_atm_soft_tissue',array('rows'=>6, 'cols'=>50)); ?>
		<?php echo $form->error($model,'observation_atm_soft_tissue'); ?>
	</div>
