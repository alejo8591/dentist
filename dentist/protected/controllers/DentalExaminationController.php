...
class DentalExaminationController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('DentalExamination');
	...
	{
		$model=new DentalExamination('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['DentalExamination']))
			$model->attributes=$_GET['DentalExamination'];
	 ...
	 * @return DentalExamination the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=DentalExamination::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param DentalExamination $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='dental-examination-form')
		{
