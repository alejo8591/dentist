...
class Rh1Controller extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Rh1');
	...
	{
		$model=new Rh1('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Rh1']))
			$model->attributes=$_GET['Rh1'];
	 ...
	 * @return Rh1 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Rh1::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Rh1 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rh1-form')
		{
