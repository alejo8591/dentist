...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_anamnesis` (
  ...
  `paternal_surname` VARCHAR(64) NULL DEFAULT NULL,
  `mothers_maiden_name` VARCHAR(64) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_tbl_anamnesis_tbl_healt_institution`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_anamnesis_tbl_user1`
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_healt_institution` (
  ...
  `id_tbl_healt_regimen` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_personal_background` (
  ...
  `update_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id_tbl_personal_background`),
  INDEX `fk_tbl_personal_background_tbl_anamnesis1_idx` (`id_tbl_anamnesis` ASC),
  CONSTRAINT `fk_tbl_personal_background_tbl_anamnesis1`
    FOREIGN KEY (`id_tbl_anamnesis`)
    REFERENCES `dentist`.`tbl_anamnesis` (`id_tbl_anamnesis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_physical_examination` (
  ...
  `update_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id_tbl_physical_examination`),
  INDEX `fk_tbl_physical_examination_tbl_anamnesis1_idx` (`id_tbl_anamnesis` ASC),
  CONSTRAINT `fk_tbl_physical_examination_tbl_anamnesis1`
    FOREIGN KEY (`id_tbl_anamnesis`)
    REFERENCES `dentist`.`tbl_anamnesis` (`id_tbl_anamnesis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_atm` (
  ...
  `update_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id_tbl_atm`),
  INDEX `fk_tbl_atm_tbl_anamnesis1_idx` (`id_tbl_anamnesis` ASC),
  CONSTRAINT `fk_tbl_atm_tbl_anamnesis1`
    FOREIGN KEY (`id_tbl_anamnesis`)
    REFERENCES `dentist`.`tbl_anamnesis` (`id_tbl_anamnesis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_atm` (
  ...
  INDEX `fk_tbl_options_atm_tbl_atm1_idx` (`id_tbl_atm` ASC),
  CONSTRAINT `fk_tbl_options_atm_tbl_atm`
    FOREIGN KEY (`id_tbl_atm`)
    REFERENCES `dentist`.`tbl_atm` (`id_tbl_atm`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_social_habits` (
  ...
  INDEX `fk_tbl_options_social_habits_tbl_personal_background1_idx` (`id_tbl_personal_background` ASC),
  CONSTRAINT `fk_tbl_options_social_habits_tbl_personal_background1`
    FOREIGN KEY (`id_tbl_personal_background`)
    REFERENCES `dentist`.`tbl_personal_background` (`id_tbl_personal_background`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_oral_habits` (
  `id_tbl_option_oral_habits` INT(11) NOT NULL AUTO_INCREMENT,
  `id_tbl_personal_background` INT(11) NOT NULL,
  ...
  INDEX `fk_tbl_options_oral_habits_tbl_personal_background1_idx` (`id_tbl_personal_background` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_dental_history` (
  ...
  INDEX `fk_tbl_options_dental_history_tbl_personal_background1_idx` (`id_tbl_personal_background` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_pathological_history` (
  ...
  INDEX `fk_tbl_options_pathological_history_tbl_personal_background_idx` (`id_tbl_personal_background` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_obstetric_gynecology` (
  ...
  INDEX `fk_tbl_options_obstetric_gynecology_tbl_personal_background_idx` (`id_tbl_personal_background` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_personal_background` (
  ...
  INDEX `fk_tbl_options_personal_background_tbl_personal_background1_idx` (`id_tbl_personal_background` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_vital_signs` (
  `id_tbl_option_vital_signs` INT(11) NOT NULL AUTO_INCREMENT,
  `id_tbl_physical_examination` INT(11) NOT NULL,
  `name_option_vital_signs` VARCHAR(128) NULL DEFAULT NULL,
  `flag_option_vital_signs` INT(11) NULL DEFAULT NULL,
  `observation_option_vital_signs` TEXT NULL DEFAULT NULL,
  `create_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `create_time` DATETIME NULL DEFAULT NULL,
  `update_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id_tbl_option_vital_signs`),
  INDEX `fk_tbl_options_vital signs_tbl_physical_examination1_idx` (`id_tbl_physical_examination` ASC),
  CONSTRAINT `fk_tbl_options_vital_signs_tbl_physical_examination`
    FOREIGN KEY (`id_tbl_physical_examination`)
    REFERENCES `dentist`.`tbl_physical_examination` (`id_tbl_physical_examination`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_extraoral_examination` (
  ...
  INDEX `fk_tbl_options_extraoral_examination_tbl_physical_examinati_idx` (`id_tbl_physical_examination` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_neck` (
  ...
  INDEX `fk_tbl_options_neck_tbl_physical_examination1_idx` (`id_tbl_physical_examination` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_lymphadenopathy` (
  `id_tbl_option_lymphadenopathy` INT(11) NOT NULL AUTO_INCREMENT,
  `id_tbl_physical_examination` INT(11) NOT NULL,
  ...
  INDEX `fk_tbl_options_lymphadenopathy_tbl_physical_examination1_idx` (`id_tbl_physical_examination` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_systems` (
  `id_tbl_option_systems` INT(11) NOT NULL AUTO_INCREMENT,
  `id_tbl_physical_examination` INT(11) NOT NULL,
  ...
  INDEX `fk_tbl_options_systems_tbl_physical_examination1_idx` (`id_tbl_physical_examination` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_atm_mandibular_movements` (
  ...
  INDEX `fk_tbl_options_atm_mandibular_movements_tbl_atm1_idx` (`id_tbl_atm` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_atm_soft_tissue` (
  ...
  INDEX `fk_tbl_options_atm_soft_tissue_tbl_atm1_idx` (`id_tbl_atm` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_dental_examination` (
  ...
  `update_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id_tbl_dental_examination`),
  INDEX `fk_tbl_dental_examination_tbl_anamnesis1_idx` (`id_tbl_anamnesis` ASC),
  CONSTRAINT `fk_tbl_dental_examination_tbl_anamnesis1`
    FOREIGN KEY (`id_tbl_anamnesis`)
    REFERENCES `dentist`.`tbl_anamnesis` (`id_tbl_anamnesis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_periodontal_examination` (
  ...
  PRIMARY KEY (`id_tbl_periodontal_examination`),
  INDEX `fk_tbl_periodontal_examination_tbl_anamnesis1_idx` (`id_tbl_anamnesis` ASC),
  CONSTRAINT `fk_tbl_periodontal_examination_tbl_anamnesis1`
    FOREIGN KEY (`id_tbl_anamnesis`)
    REFERENCES `dentist`.`tbl_anamnesis` (`id_tbl_anamnesis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_intcp` (
  ...
  INDEX `fk_tbl_intcp_tbl_periodontal_examination1_idx` (`id_tbl_periodontal_examination` ASC),
  CONSTRAINT `fk_tbl_intcp_tbl_periodontal_examination`
    FOREIGN KEY (`id_tbl_periodontal_examination`)
    REFERENCES `dentist`.`tbl_periodontal_examination` (`id_tbl_periodontal_examination`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_dental_pieces` (
  ...
  INDEX `fk_tbl_dental_pieces_tbl_dental_examination1_idx` (`id_tbl_dental_examination` ASC),
  CONSTRAINT `fk_tbl_dental_pieces_tbl_dental_examination1`
    FOREIGN KEY (`id_tbl_dental_examination`)
    REFERENCES `dentist`.`tbl_dental_examination` (`id_tbl_dental_examination`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_caries_risk_classification` (
  ...
  INDEX `fk_tbl_caries_risk_classification_tbl_dental_examination1_idx` (`id_tbl_dental_examination` ASC),
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_diagnosis` (
  ...
  `update_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id_tbl_diagnosis`),
  INDEX `fk_tbl_diagnosis_tbl_anamnesis1_idx` (`id_tbl_anamnesis` ASC),
  CONSTRAINT `fk_tbl_diagnosis_tbl_anamnesis1`
    FOREIGN KEY (`id_tbl_anamnesis`)
    REFERENCES `dentist`.`tbl_anamnesis` (`id_tbl_anamnesis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_diagnosis` (
  ...
  INDEX `fk_tbl_options_diagnosis_tbl_diagnosis1_idx` (`id_tbl_diagnosis` ASC),
  CONSTRAINT `fk_tbl_options_diagnosis_tbl_diagnosis`
    FOREIGN KEY (`id_tbl_diagnosis`)
    REFERENCES `dentist`.`tbl_diagnosis` (`id_tbl_diagnosis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_prognosis` (
  ...
  `update_user_id` VARCHAR(64) NULL DEFAULT NULL,
  `update_time` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`id_tbl_prognosis`),
  INDEX `fk_tbl_prognosis_tbl_anamnesis1_idx` (`id_tbl_anamnesis` ASC),
  CONSTRAINT `fk_tbl_prognosis_tbl_anamnesis1`
    FOREIGN KEY (`id_tbl_anamnesis`)
    REFERENCES `dentist`.`tbl_anamnesis` (`id_tbl_anamnesis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dentist`.`tbl_options_prognosis` (
  ...
  INDEX `fk_tbl_options_prognosis_tbl_prognosis1_idx` (`id_tbl_prognosis` ASC),
  CONSTRAINT `fk_tbl_options_prognosis_tbl_prognosis`
    FOREIGN KEY (`id_tbl_prognosis`)
    REFERENCES `dentist`.`tbl_prognosis` (`id_tbl_prognosis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
